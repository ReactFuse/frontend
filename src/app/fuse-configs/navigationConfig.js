...
const navigationConfig = [
	{
		...
		children: [
			...
			// },
			{
				id: 'users',
				title: 'Users Manage',
				translate: 'Users Manage',
				type: 'item',
				icon: 'account_box',
				url: '/apps/users-manage',
				auth: authRoles.admin
			},
			{
				id: 'license',
				title: 'Trading License',
				translate: 'Trading License',
				type: 'item',
				icon: 'assessment',
				url: '/apps/calendar',
				auth: ['admin', 'manager']
			...
			// {
			// 	id: 'Servers Managment',
			// 	title: 'Server Management',
			// 	translate: 'Server Management',
			// 	type: 'item',
			...
			// {
			// 	id: 'apps',
			// 	title: 'Apps Managment',
			// 	translate: 'Apps Managment',
			// 	type: 'item',
			// 	icon: 'apps',
			// 	url: '/apps/apps-manage'
			// 	// badge: {
			// 	// 	title: 13,
			// 	// 	bg: 'rgb(9, 210, 97)',
			// 	// 	fg: '#FFFFFF'
