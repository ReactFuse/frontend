...
export default function Addservers({ open, handleClose, handleClickOpen, handleUpdate }) {
	...
	const [values, setValues] = useState({
		...
		cancelTime: '',
		endTime: new Date('2021-08-18T21:11:54'),
		lastPingTime: new Date('2021-08-18T21:11:54'),
		autoRenew: new Date('2021-08-18T21:11:54')
	});
	...
	async function handleSubmit() {
		let res = await addServers(values);
		console.log(res);
	...
	return (
		<div>
			...
			<Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
				...
				<DialogContent>
					<DialogContentText>Add New Server Details</DialogContentText>
					{users && (
