...
import { addRobots } from '../../connection/Robots';
...
export default function AddRobots({ open, handleClose, handleClickOpen, handleUpdate }) {
	...
	async function handleSubmit() {
		let res = await addRobots(values);
		console.log(res);
	...
	return (
		<div>
			...
			<Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
				<DialogTitle id="form-dialog-title">Add New Robot</DialogTitle>
				<DialogContent>
					<DialogContentText>Add New Robot Details</DialogContentText>
					<textarea
