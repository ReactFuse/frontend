...
import { editApps } from '../../connection/Apps';
...
export default function Editapps({ open, handleClose, handleClickOpen, data, handleUpdate }) {
	...
	return (
		<div>
			<Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
				<DialogTitle id="form-dialog-title">Edit Apps</DialogTitle>
				<DialogContent>
					<DialogContentText>Edit Apps Details</DialogContentText>
					{users && (
