...
import { editPlans } from '../../connection/Plans';
...
export default function EditPlans({ open, handleClose, handleClickOpen, data, handleUpdate }) {
	...
	async function handleSubmit() {
		let res = await editPlans(values);
	...
	return (
		<div>
			<Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
				...
				<DialogContent>
					<DialogContentText>Edit Plan Details</DialogContentText>
					<textarea
