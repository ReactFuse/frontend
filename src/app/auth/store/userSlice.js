...
export const setUserData = user => (dispatch, getState) => {
	/*
	...
	console.log('globle data ', globledata);
    ...
    Set User Settings
     */
	console.log('userSlice data da  ', user);
...
// 	role: [], // guest
// 	data: {
// 		displayName: 'Uzair khan', //globledata.displayName,
// 		photoURL: 'assets/images/avatars/Velazquez.jpg', //globledata.photoURL,
// 		email: 'uzairkhan@gmail.com' //globledata.email,
// 	}
// };
